...
def get_args():
    ...
    ###############################
    # Settings for multiuser cases
    ##############################
    parser.add_argument('-divloss', type=bool, default=False) #whether to use loss to encourage the differences between different encoders
    parser.add_argument('-divlosscoef', type=float, default=0.01) #div loss coeffcient
    parser.add_argument('-nuser',type=int, default=2, help ='number of users')
    parser.add_argument('-gamma1',type=float, default=0.8, help ='coefficient of interference of user 1')
    parser.add_argument('-gamma2',type=float, default=0.8, help ='coefficient of interference of user 2')
    parser.add_argument('-gamma',type=float, default=0.8, help ='coefficient of interference')
    #=============================
    ...
    parser.add_argument('-channel', choices = ['awgn',             # AWGN
                                               ...
                                               'rayleigh',            # Non-coherent Rayleigh Fading AWGN Channel
                                               'rician',
    ...
    parser.add_argument('-train_channel_mode',
                        choices=['block_norm','block_norm_ste'],
                        default='block_norm')
    parser.add_argument('-conditions', type=str, default='same')
    parser.add_argument('-padding', type=str, default='circular')
    parser.add_argument('-interleaver', choices=['none', 'uniform_same','uniform_different', 'grid', 'trainable'], default='grid')
    # Channel parameters
    parser.add_argument('-vv',type=float, default=5, help ='only for t distribution channel')

    # continuous channels training algorithms
    parser.add_argument('-train_enc_channel_low', type=float, default  = 2.0)
    parser.add_argument('-train_enc_channel_high', type=float, default = 2.0)
    ...
    parser.add_argument('-dec_lr', type = float, default=0.00002, help='decoder leanring rate')
    parser.add_argument('-enc_lr', type = float, default=0.00002, help='encoder leanring rate')
