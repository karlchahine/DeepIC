...
from deepcomm.convcode import conv_encode
from deepcomm.interleaver import Interleaver
from deepcomm.utils import dec2bitarray
...
def bcjr_decode(sys_llrs, non_sys_llrs, trellis, L_int, method = 'max_log_MAP'):
    if method not in ['max_log_MAP', 'log_MAP']:
        method = 'log_MAP'
